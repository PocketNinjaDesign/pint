...
const waMusic = new WebAudio('audio/tracks/something.mp3', 128, 32, );
waMusic.loadAudioTrack();
// const waVinylSound = new WebAudio('audio/vinyl-sounds/vinyl-crackle-end-loop.mp3', 128, 32, );
const myPlayer = new Player(waMusic);
